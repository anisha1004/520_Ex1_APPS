"""
Test runner for buggy version of solve_3177_v2
...
from Claude_SelfDebug_Buggy import solve_3177_v2_buggy

# Monkey-patch the solutions module to use buggy version
import solutions.Claude_SelfDebug as claude_module
claude_module.solve_3177_v2 = solve_3177_v2_buggy

# Now import and run tests - they will use the buggy version
import pytest

if __name__ == "__main__":
    test_file = project_root / "PART2_SOLUTION" / "Problem_3177_Solution" / "test_Claude_SelfDebug_solve_3177_v2_enhanced.py"
